                ...
                <Paper style={{width: "100%", marginTop: "5px"}}>
                  <Grid container xs={12} style={{padding: "10px"}}>
                    ...
                    <Grid xs={4} style={{marginLeft: "20px", marginTop: "30px"}}>
                        <h5>{cart.cartName}</h5> <p>₱{cart.cartPrice}.00 / pcs</p>
                    </Grid>
                    <Grid xs={3} style={{marginTop: "40px", textAlign: "center"}}>
                      <h1>{cart.cartPcs}</h1>
                    </Grid>
                    <Grid xs={1} style={{ textAlign: "center" }}>
                      
                       <Fab size="small" style={{marginTop: "20px", color: "white", backgroundColor: "#ECD14C"}}
                        onClick={() => {
                            addCartValue(cart);
                           }}
                       ><AddOutlinedIcon /></Fab>
                       <Fab size="small" style={{marginTop: "5px", color: "white", backgroundColor: "#DA6C77"}}
                       onClick={() => {
                        subCartValue(cart);
                       }}
                       ><RemoveOutlinedIcon/></Fab>
